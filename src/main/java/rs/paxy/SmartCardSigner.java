...
public class SmartCardSigner {
    ...
    public SmartCardSigner(String file, String signedFile, String pin)
        ...
        String configName = "pkcs11-posta.cfg";
        ...
        sign(file, signedFile, chain, privateKey, DigestAlgorithms.SHA256, provider1.getName(),
                PdfSigner.CryptoStandard.CMS, null, null);
    ...
    public static void main(String[] args) throws Exception {
        ...
        String signedFile=path+"/"+name.replace(".pdf", "-sign.pdf");
        ...
        new SmartCardSigner(input.getAbsolutePath(), signedFile, pin);
    }
